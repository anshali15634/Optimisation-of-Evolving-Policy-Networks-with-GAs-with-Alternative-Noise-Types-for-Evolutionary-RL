...
class GAMSM_P2:
    ...
    # This implementation of GA-MSM-P is specifically adapted to accommodate the CartPole environment and facilitate noise injection in continuous action spaces. 
